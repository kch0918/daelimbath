	...
	<div class="layer-popup" style="max-width:900px;">
		<div class="popup-container">
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td>
      												<input type="text" id="submit_date" name="submit_date" placeholder="가입일" disabled/>
												</td>
											</tr>
			...
			<div class="popup-btn">
				...
				<button type="button" class="popup-close btn btn_a_type" onclick="fncSubmit();">수정</button>
			</div>
		</div>
	<!-- //회원 정보 상세 팝업 끝 -->
