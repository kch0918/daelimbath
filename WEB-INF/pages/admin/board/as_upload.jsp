	...
	if(validationFlag == "Y")
	{
	      $("#fncForm").ajaxSubmit({
			success: function(data)
			{
	    		...
	    		{
	    			alert(result.msg);
	     			location.href = '/admin/board/as_list';
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div id="container">
	<div class="contain_inner">
		<div class="admin-top">
			<h1 class="admin-title">AS/설치 가이드 등록/수정</h1>
		</div>
		<form id="fncForm" name="fncForm" action="/admin/board/as_upload_proc" method="post" enctype="multipart/form-data">
					...
					<table>
		   				...
		   				<tbody>
						    ...
						    <tr>
		                        ...
		                        <td>
		                        	<input type="text" class="info_area notEmpty" id="imbecode" name="imbecode" data-name="임베디드 코드"/>
			                    </td>
							</tr>
						    <tr>
