	...
	if(validationFlag == "Y")
	{
	      $("#fncForm").ajaxSubmit({
			success: function(data)
			{
	    		...
	    		{
	    			alert(result.msg);
	     			location.href = '/admin/board/cata_list';
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
function init() {
	...
	if(cata_cate == 1)
	{
		$("#cata_cate").val('1').prop("selected", true);
		
	}
	else if(cata_cate == 2)
	{
		$("#cata_cate").val('2').prop("selected", true);
...
<div id="container">
	<div class="contain_inner">
		<div class="admin-top">
			<h1 class="admin-title">카탈로그 등록/수정</h1>
		</div>
		<form id="fncForm" name="fncForm" action="/admin/board/cata_upload_proc" method="post" enctype="multipart/form-data">
		    <div class="insert-form-box">
				<div class="input-table">
					<table>
		   				...
		   				<tbody>
							<tr>
								<th><label for="cata_nm">제목<span class="required-mark">*</span></label>
			                    <td>
			                        <input type="text" class="info_area notEmpty" id="main_title" name="main_title" placeholder="제목을 입력해주세요 " data-name="제목"/>
			                    </td>
							</tr>
							<tr>
								<th><label for="cata_cate">카테고리<span class="required-mark">*</span></label>
			                    <td>
			                        <select name="cata_cate" id="cata_cate">
			                        	<option value="1">바스</option>
			                        	<option value="2">바스&키친</option>
			                        </select>
			                    </td>
							</tr>
						    <tr>
						    ...
						    <tr>
		                        ...
		                        <td class="file_add">
		                        	<div class="input-file-box">
		                        		...
		                        		<span class="input-file">
					                       	<input type="text" id="fake_cata_file" class="imgNm fake-upload notEmpty" placeholder="첨부파일"  data-name="첨부파일 등록"/>
