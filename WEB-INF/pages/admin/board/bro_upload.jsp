	...
	if(validationFlag == "Y")
	{
	      $("#fncForm").ajaxSubmit({
			success: function(data)
			{
	    		...
	    		{
	    			alert(result.msg);
	     			location.href = '/admin/board/bro_list';
	    		}
	    		else
	    		{
	    			alert(result.msg);
...
<div id="container">
	<div class="contain_inner">
		<div class="admin-top">
			<h1 class="admin-title">브로슈어&리플렛 등록/수정</h1>
		</div>
		<form id="fncForm" name="fncForm" action="/admin/board/bro_upload_proc" method="post" enctype="multipart/form-data">
		    <div class="insert-form-box">
				<div class="input-table">
					<table>
		   				...
		   				<tbody>
							<tr>
								<th><label for="bro_nm">제목<span class="required-mark">*</span></label></td>
			                    <td>
