...
function fncSubmit()
{
	...
	$("#fncForm").ajaxSubmit({
			success: function(data)
			{
	    		...
	    		{
	    			alert(result.msg);
	    			location.href="/cscenter/cs_write_complete"; 
	    		}
	    		else
	    		{
	    			alert(result.msg);
	...
	<div class="pagew cs_center cs_write">
		<div class="mypage_wrap my_list select_custom">
			<div class="content">
				
				<div class="write_tit">					
					<h2>1:1 문의하기</h2>
					<h3>1:1문의 시 사진,동영상을 함께 전달해주시면<br class="dis-no vis-570"> 더욱 빠른 서비스가 가능합니다.</h3>
				</div>
				<form id="fncForm" name="fncForm" method="post" action="cs_write_proc" enctype="multipart/form-data">
