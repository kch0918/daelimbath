...
// 로그인 세션 
var login_name2 = "<%=Utils.checkNullString(session.getAttribute("join_corp_biz"))%>";

console.log("기업 : " + login_name2);
	...
	<div id="wrap" class="join">
		...
		<div class="join_pagew">
				...
				<div class="join_cont line">
					<div class="main_txt">회원가입 완료</div>
						<div class="mem_icon">	
				        	...
				        	${join_corp_biz} 고객님, 회원가입이 완료 되었습니다.
				        </div>	        
			...
			<div class="write_btn">
				<a href="/member/login" class="submit">로그인</a>
			</div>
