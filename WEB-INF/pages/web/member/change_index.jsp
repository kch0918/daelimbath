...
function fncSubmit()
{
	...
	<div id="wrap" class="mypage">
		...
		<div class="pagew">
 		<form id="fncForm" name="fncForm" method="post" action="/member/chg_idx_proc">
				...
				<div class="content">
					<div class="search_box change">
						...
						<div class="write_cont">
							<div class="cs_txt2">
								회원님의 정보를 안전하게 보호하기 위해<br class="dis-no vis-767"> 비밀번호를 다시 한 번 확인해 주세요.
							</div>
							<div class="as_txt">
								<div>
								...
								<div>
									...
									<input type="password" name="pw"  onkeypress="enter_check(fncSubmit)"/>
								</div>
							</div>					
						</div>	
