		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner += '			<a href="/upload/down/'+result.list[i].cata_file_ori+'" download><span class="down_clickTxt"> '+result.list[i].cata_file+' </span></a>';	
					inner += '		</div>';
					inner += '		</div>';
        ...
        <div class="section01">
            <div class="tab_content">
                <div class="cont_pagew">
                    <div class="tab">
                        <ul>
                            <li class="on"><a href="/download/catalog">카탈로그</a></li>
            ...
            <div class="prod_cate banner-up">
                ...
                <div class="cont_pagew catal_btn">
                    <div class="cate_list prod_catelist">
                        <div id="cate_area">
                            <input type="text" id="search" name="search_name" placeholder="카탈로그 명을 입력해주세요." onkeypress="javascript:pagingReset(); excuteEnter(getList);"/>
                        </div>
                        <button >
