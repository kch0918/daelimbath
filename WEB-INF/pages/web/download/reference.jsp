                ...
                <div class="cont_pagew">
                    <div class="tab">
                     	<ul>
                            ...
                            <li class="on"><a href="/download/reference">기타 자료실</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="prod_cate banner-up">
                ...
                <div class="cont_pagew catal_btn">
                    <div class="cate_list prod_catelist">
                        <div id="cate_area">
                            <input type="text" id="search" name="search_name" placeholder="검색어를 입력해주세요." onkeypress="javascript:pagingReset(); excuteEnter(getList);"/>
                        </div>
                        <button >
